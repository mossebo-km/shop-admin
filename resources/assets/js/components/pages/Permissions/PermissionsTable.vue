<script>
  ...
  import PermissionsTableModel from '../../../resources/PermissionsTableModel'
  ...
  export default {
    ...
    data() {
      return {
        tableItemsDataName: 'permissions',
      }
    },

    methods: {
      initItems (items = []) {
        this.items = this.getSortedData(items).map(item => new PermissionsTableModel(item))
      },
    }
  }
</script>
